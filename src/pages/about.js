    ...
    <>
      ...
      <progress max="100" value="0"></progress>
        ...
        <div className="w-full h-full flex justify-center items-center realizzazioni">
          ...
          __Omni channel customer experiences
          </p>
            ...
            <section ref={(el) => (textRefs.current[1] = el)} className="default mt-16 mb-16"><StaticImage src="../images/u2.jpg" alt="A dinosaur" /></section>
            ...
            <p id="quote-two" className="text-white list-none text-6xl md:text-6xl lg:text-8xl font-extra-black relative overflow-hidden uppercase transform phrase">

    ...
    <>
      <main className="container mx-auto px-2 md:px-0">
        ...
        <div className="text-3xl w-full mx-auto justify-center flex font-bold hometex opacity-0">
          ...
          <StaticImage src="../images/DSC02014-3.jpg" alt="A dinosaur" />
          <StaticImage src="../images/DSC02024.jpg" alt="A dinosaur" />
          <StaticImage src="../images/DSC02029.jpg" alt="A dinosaur" />
